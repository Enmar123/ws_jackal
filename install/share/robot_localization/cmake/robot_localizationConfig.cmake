...
if("FALSE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/lattice/ws_jackal/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/lattice/ws_jackal/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/lattice/ws_jackal/install)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lattice/ws_jackal/install/${idir}'.  ${_report}")
    endif()
